...
const customFiles = import.meta.glob('@/gildsmith/dashboard/lang/**/*.json', {
    import: 'default',
    eager: true,
})

const composerFiles = import.meta.glob('@composer/*/*/resources/js/dashboard/lang/**/*.json', {
    import: 'default',
    eager: true,
})

const npmFiles = import.meta.glob('@npm/*/*/resources/js/dashboard/lang/**/*.json', {
    import: 'default',
    eager: true,
})
